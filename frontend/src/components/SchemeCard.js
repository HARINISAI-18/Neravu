...
const UI = {
  ...
  bn: {
    eligible: "✓ আপনি সম্ভবত যোগ্য",
    possibly: "? সম্ভাব্য যোগ্যতা — শর্ত যাচাই করুন",
    notEligible: "✗ যোগ্য নয়",
    amount: (inr) => `${inr} পর্যন্ত কভারেজ`,
    more: (n) => `+ আরো ${n} টি`,
    details: "বিস্তারিত ও নথিপত্র",
    hide: "লুকান",
    docs: "প্রয়োজনীয় নথিপত্র",
    docsProgress: (a, b) => `${b} টির মধ্যে ${a} টি সংগৃহীত`,
    infoApply: "তথ্য / আবেদন →",
    share: "শেয়ার করুন",
  },
  ta: {
    eligible: "✓ நீங்கள் தகுதியானவர்",
    possibly: "? தகுதியிருக்கலாம் — நிபந்தனைகளைச் சரிபார்க்கவும்",
    notEligible: "✗ தகுதியற்றவர்",
    amount: (inr) => `${inr} வரை காப்பீடு`,
    more: (n) => `+ மேலும் ${n}`,
    details: "விவரங்கள் மற்றும் ஆவணங்கள்",
    hide: "மறை",
    docs: "தேவையான ஆவணங்கள்",
    docsProgress: (a, b) => `${b}-ல் ${a} சேகரிக்கப்பட்டது`,
    infoApply: "தகவல் / விண்ணப்பிக்க →",
    share: "பகிர்",
  },
  gu: {
    eligible: "✓ તમે કદાચ પાત્ર છો",
    possibly: "? સંભવિત પાત્રતા — શરતો ચકાસો",
    notEligible: "✗ પાત્ર નથી",
    amount: (inr) => `${inr} સુધીનું કવરેજ`,
    more: (n) => `+ ${n} વધુ`,
    details: "વિગતો અને દસ્તાવેજો",
    hide: "છુપાવો",
    docs: "જરૂરી દસ્તાવેજો",
    docsProgress: (a, b) => `${b} માંથી ${a} એકત્રિત`,
    infoApply: "માહિતી / અરજી કરો →",
    share: "શેર કરો",
  },
};
