...
const UI = {
  ...
  bn: {
    title: 'রোগীর তথ্য — স্কিম খুঁজুন',
    skip: 'এড়িয়ে যান',
    step: 'ধাপ', question: 'প্রশ্ন',
    multiHint: '(সব প্রযোজ্য নির্বাচন করুন)',
    optionsLabel: 'বিকল্পসমূহ:',
    back: '← পিছনে', skipQ: 'এই প্রশ্ন এড়িয়ে যান',
    next: 'পরবর্তী →', finish: 'আমার স্কিম খুঁজুন',
    placeholder: '…অথবা আপনার রাজ্য/শহর লিখুন',
    hint: 'আপনার উত্তর শুধুমাত্র উপযুক্ত স্কিম খোঁজার জন্য — এরপর আপনি চ্যাট করতে পারেন।',
  },
  ta: {
    title: 'நோயாளி தகவல் — திட்டங்களை தேடு',
    skip: 'தவிர்',
    step: 'படி', question: 'கேள்வி',
    multiHint: '(பொருத்தமானவற்றை தேர்வு செய்)',
    optionsLabel: 'விருப்பங்கள்:',
    back: '← பின்', skipQ: 'இந்த கேள்வியை தவிர்',
    next: 'அடுத்து →', finish: 'திட்டங்களை கண்டுபிடி',
    placeholder: '…அல்லது உங்கள் மாநிலம்/நகரம்',
    hint: 'தகவல் திட்டங்களை தர மட்டுமே பயன்படுத்தப்படும் — பின்னர் நீங்கள் நேரடியாக உரையாடலாம்.',
  },
  gu: {
    title: 'દર્દીની માહિતી — યોજનાઓ શોધો',
    skip: 'છોડી દો',
    step: 'પગલું', question: 'પ્રશ્ન',
    multiHint: '(લાગુ પડતા બધા પસંદ કરો)',
    optionsLabel: 'વિકલ્પો:',
    back: '← પાછા', skipQ: 'આ પ્રશ્ન છોડો',
    next: 'આગળ →', finish: 'મારી યોજનાઓ શોધો',
    placeholder: '…અથવા તમારું રાજ્ય/શહેર લખો',
    hint: 'તમારા જવાબોથી તમને યોગ્ય યોજનાઓ મળશે — પછી તમે ચેટ કરી શકો છો.',
  },
};
